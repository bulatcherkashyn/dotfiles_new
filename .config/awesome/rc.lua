...
local function run_once2(cmd_arr)
	for _, cmd in ipairs(cmd_arr) do -- Исправлено: _ и cmd_arr
		awful.spawn.with_shell(string.format("pgrep -u $USER -fx '%s' > /dev/null || (%s)", cmd, cmd))
	end
end
...
globalkeys = my_table.join(
	...
	end, { description = "htop", group = "super" }),
	awful.key({ modkey, "Shift" }, "b", function()
		awful.util.spawn("alacritty -e btop")
	end, { description = "htop", group = "super" }),
	--
	...
	awful.key({ modkey }, "x", function()
		awful.util.spawn("rofi -show power-menu -modi power-menu:~/custom_progs/rofi-power-menu/rofi-power-menu")
	end, { description = "exit", group = "hotkeys" }),
	awful.key({ modkey, "Shift" }, "x", function()
		awful.util.spawn("arcolinux-powermenu")
	end, { description = "exit", group = "hotkeys" }),
	...
	awful.key({ modkey, "Shift" }, "Return", function()
		awful.spawn.with_shell("alacritty -e yazi")
	end),
	...
	awful.key({}, "Print", function()
		awful.spawn.with_shell(
			"maim ~/Pictures/$(date +%s).png && notify-send -t 1000 'Maim' 'Fullscreen taken and saved'"
		)
	end, { description = "Maim", group = "screenshots" }),
	awful.key({ "Shift" }, "Print", function()
		awful.spawn.with_shell(
			"maim --select | xclip -selection clipboard -target image/png && notify-send -t 1000 'Maim' 'Captured screen taken and saved to clipboard' "
		)
	end, { description = "Maim", group = "screenshots" }),
...
--awful.spawn.with_shell("redshift -l 50:19")
--awful.spawn.with_shell("unclutter")
--awful.spawn.with_shell("dunst")
awful.spawn.with_shell("nitrogen --restore")
--awful.spawn.with_shell("udiskie -ant")
